...
export type { TagId, Tags } from './schema/tags.js';
export type { CollectionTag, ScalarTag } from './schema/types.js';
export type { YAMLOMap } from './schema/yaml-1.1/omap.js';
export type { YAMLSet } from './schema/yaml-1.1/set.js';
